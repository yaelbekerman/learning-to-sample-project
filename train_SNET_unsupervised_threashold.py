...
parser.add_argument('--classifier_model_path', default='log/baseline/PointNet1024/model.ckpt', help='Path to model.ckpt file of a pre-trained classifier')
...
parser.add_argument('--log_dir', default='log/SNET64UNSUPERVISEDpoint7', help='Log dir [default: log/SNET64]')
