...
parser.add_argument('--log_dir', default='log/SNET64test', help='Log dir [default: log/SNET64]')
parser.add_argument('--data_remain', default=1, help='how many train files to use out of five - needs to be an number between 1 and 5')
...
DATA_KEEP_NUM = FLAGS.data_remain
