...
parser.add_argument('--sampler_model_path', default='log/SNET32UNSUPERVISEDmnist/model.ckpt', help='Path to model.ckpt file of S-NET')
...
parser.add_argument('--num_out_points', type=int, default=32, help='Number of output points [2,4,...,1024] [default: 64]')
...
def evaluate():
    with tf.device('/gpu:' + str(GPU_INDEX)):
        ...
        with tf.variable_scope('classifier' + str(NUM_OUT_POINTS)):
