...
parser.add_argument('--sampler_model_path', default='log/SNET512PARTDATA/model.ckpt', help='Path to model.ckpt file of S-NET')
...
parser.add_argument('--num_out_points', type=int, default=512, help='Number of output points [2,4,...,1024] [default: 64]')
